...
- [ ] **Phase J dev instrumentation started:** sketch-driven runs now emit `debug-overlay.html` for labeled curve review. Remaining work: interpretation trace score tables and readiness extension fields.
